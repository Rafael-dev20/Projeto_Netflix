...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark">
        <a class="navbar-brand" href="#"> <img src="{{ asset('/images/petflix.svg') }}" class="logo"> </a>
    </nav>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content" style="background-color: #efefef">
                    <div class="modal-body text-dark">
                        ...
                        <form class="pl-4 pr-4" method="post" action="{{ route('login') }}">
                            @csrf
                            ...
                            <div class="text-center mt-5 mb-1">
                                ...
                                <a class="text-danger" href="#" data-toggle="modal"
                                    data-target="#mdRegister">Cadastre-se aqui</a>
                            </div>
    ...
    @endif
    <!-- Modal -->
    <div class="modal fade" id="mdRegister" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <form class="pl-4 pr-4" method="post" action="{{ route('register') }}">
                        @csrf
                        <div class="form-group">
                            <label>Nome</label>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="dt_nascimento" class="form-control" id="dateInput">
                        </div>
